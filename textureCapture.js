...
module.exports = function(clmPositions, options) {
  ...
  if (typeof options.video !== "undefined") options.image = options.video;

  options.clip = options.clip !== false;

  var image = options.image;
  if (!options.image) throw new Error("Must specify an image");

  var imgScaleX = typeof image.videoWidth === "undefined"
    ? 1
    : image.width / image.videoWidth;
  var imgScaleY = typeof image.videoHeight === "undefined"
    ? 1
