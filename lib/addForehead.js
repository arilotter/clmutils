...
module.exports = function( clmPositions, numPointsToAdd ) {

	if( clmPositions ) {

		numPointsToAdd = numPointsToAdd || 8;
		...
		if( rightRadOff > 0 && rightRadOff <  TWO_PI )
			rightRadOff += TWO_PI;

		radInc = Math.PI / numPointsToAdd;

		console.log( leftRadOff, rightRadOff );


		for( var i = 0, len = numPointsToAdd; i < len; i++ ) {
